...
*/
/** @ClassName FastAutoGeneratorTest.java @ProjectName demo *//*
...
/** 数据源配置 *//*
            ...
            private static final DataSourceConfig.Builder DATA_SOURCE_CONFIG = new DataSourceConfig
            		.Builder("jdbc:mysql://localhost:3306/test?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "abc123")
...
/** 执行 run *//*
             ...
             public static void main(String[] args) {
             	...
             	FastAutoGenerator.create(DATA_SOURCE_CONFIG)
             			...
             			*/
/**
 * schema：在数据库中表示的是数据库对象集合，它包含了各种对像，比如：表，视图，存储过程，索引等等。 一般情况下一个用户对应一个集合，所以为了区分不同的集合就需要给不同的集合起名字。
